 ...
 */
final class Version20210602171555 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course_detail (id INT AUTO_INCREMENT NOT NULL, quantite INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE course_detail_service (course_detail_id INT NOT NULL, service_id INT NOT NULL, INDEX IDX_799EFD335A714317 (course_detail_id), INDEX IDX_799EFD33ED5CA9E6 (service_id), PRIMARY KEY(course_detail_id, service_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
